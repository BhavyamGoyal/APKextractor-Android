...
class Utilities {
    companion object {
        ...
        fun extractApk(apk: ApkData): Boolean {
            makeAppDir()
            var extracted = true
        ...
        fun getApkFile(apk: ApkData): File {
            var fileName = getAppFolder()?.path + File.separator + apk.appName + "" + apk.version + ".apk"
            return File(fileName)
        }
        fun getShareableIntent(apk: ApkData): Intent {
            extractApk(apk)
